...
static void Tyvaenergo(def nameOfBlock) {
    println('nameOfBlock:' + nameOfBlock)

    WebUI.click(findTestObject('Выручка в рублях/Раскрыть список ПАО Россети' + nameOfBlock))

    WebUI.click(findTestObject('Выручка в рублях/Раскрыть список РаспредКомплекс' + nameOfBlock))

    'Выбрать ПАО Россети'
    WebUI.click(findTestObject('Выручка в рублях/Тываэнерго' + nameOfBlock))
...
static def PreSettings(def run, def vir, def block, def nameOfBlock, def typeOfData, def todaysDate, def a1, def b1, def a2, def b2, def a3, def b3) {
    ...
    WebUI.click(findTestObject('Выручка в рублях/2023 список' + nameOfBlock))

    WebUI.scrollToElement(findTestObject('Выручка в рублях/1 квартал 2023 список' + nameOfBlock), 30)

    WebUI.click(findTestObject('Выручка в рублях/1 квартал 2023 выбрать' + nameOfBlock))

    WebUI.click(findTestObject('Выручка в рублях/2 квартал 2023 список' + nameOfBlock))

    WebUI.click(findTestObject('Выручка в рублях/Апрель' + nameOfBlock))

    WebUI.click(findTestObject('Выручка в рублях/Май ' + nameOfBlock))
