...
WebUI.click(findTestObject('Факторный анализ/Применить в фильтре Дата'))
    ...
    WebUI.scrollToElement(findTestObject('Факторный анализ/АО Дагэнергосеть'), 30)

    WebUI.click(findTestObject('Факторный анализ/АО Дагэнергосеть'))
    ...
    WebUI.scrollToElement(findTestObject('Общие объекты/Россети Янтарь нижний уровень'), 30)

    WebUI.click(findTestObject('Общие объекты/Россети Янтарь нижний уровень'))
