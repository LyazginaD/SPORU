...
WebUI.click(findTestObject('Выручка по ДЗО/3 квартал 2023 список Выручка'))

WebUI.scrollToElement(findTestObject('Выручка по ДЗО/Август Выручка'), 30)

WebUI.click(findTestObject('Выручка по ДЗО/Июль Выручка'))

WebUI.click(findTestObject('Выручка по ДЗО/Август Выручка'), FailureHandling.CONTINUE_ON_FAILURE)
