...
WebUI.verifyEqual(noSpaceText, 'АО«ВМЭС»')

if (WebUI.verifyEqual(noSpaceText, 'АО«ВМЭС»') == false) {
...
WebUI.verifyEqual(noSpaceText1, 'Астраханьэнерго')

if (WebUI.verifyEqual(noSpaceText1, 'Астраханьэнерго') == false) {
    println('Текст в списке ' + liText //System.err.println('Не совпадение списка, должен быть Читаэнерго ' + liText)
        //System.exit(1)
        )
} else {
...
WebUI.verifyEqual(noSpaceText2, 'Волгоградэнерго')

if (WebUI.verifyEqual(noSpaceText2, 'Волгоградэнерго') == false) {
...
WebUI.verifyEqual(noSpaceText3, 'Калмэнерго')

if (WebUI.verifyEqual(noSpaceText3, 'Калмэнерго') == false) {
...
WebUI.verifyEqual(noSpaceText4, 'Ростовэнерго')

if (WebUI.verifyEqual(noSpaceText4, 'Ростовэнерго') == false) {
