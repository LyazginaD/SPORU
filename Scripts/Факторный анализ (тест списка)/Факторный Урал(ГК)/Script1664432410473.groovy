...
WebUI.verifyEqual(noSpaceText, 'Пермэнерго')

if (WebUI.verifyEqual(noSpaceText, 'Пермэнерго') == false) {
...
WebUI.verifyEqual(noSpaceText1, 'Свердловэнерго')

if (WebUI.verifyEqual(noSpaceText1, 'Свердловэнерго') == false) {
...
WebUI.verifyEqual(noSpaceText2, 'Челябэнерго')

if (WebUI.verifyEqual(noSpaceText2, 'Челябэнерго') == false) {
