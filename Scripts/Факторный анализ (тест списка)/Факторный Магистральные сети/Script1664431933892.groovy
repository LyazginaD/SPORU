...
'выбрать Магистральные сети'
WebUI.click(findTestObject('null'))

'выбрать Россети ФСК ЕЭС'
WebUI.click(findTestObject('null'))

'выбрать Итого по ФСК ЕЭС'
WebUI.click(findTestObject('null'))
...
WebUI.verifyEqual(noSpaceText, 'ИтогопоФСКЕЭС')

if (WebUI.verifyEqual(noSpaceText, 'ИтогопоФСКЕЭС') == false) {
