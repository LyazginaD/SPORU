...
'выбрать Россети Томск'
WebUI.click(findTestObject('null'))

'выбрать Томская распределительная компания'
WebUI.click(findTestObject('null'))
...
WebUI.verifyEqual(noSpaceText, 'Томскаяраспределительнаякомпания')

if (WebUI.verifyEqual(noSpaceText, 'Томскаяраспределительнаякомпания') == false) {
