...
'выбрать Россети Московский регион'
WebUI.click(findTestObject('null'))

'выбрать Московская область'
WebUI.click(findTestObject('null'))
...
WebUI.verifyEqual(noSpaceText, 'Московскаяобласть')

if (WebUI.verifyEqual(noSpaceText, 'Московскаяобласть') == false) {
...
WebUI.verifyEqual(noSpaceText1, 'г.Москва')

if (WebUI.verifyEqual(noSpaceText1, 'г.Москва') == false) {
